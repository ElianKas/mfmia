			...
			<div class="flex flex-col gap-[1rem]">
				...
				<h2>
					<b
						...
						Art und Zweck von deren Verwendung</b
					>
				</h2>
				<h3><b>a) Beim Besuch der Website</b></h3>
				<p>
					Beim Aufrufen unserer Website www.miteinander-fuer-afrika.de
				...
				<h3><b>b) Bei Nutzung unseres Kontaktformulars</b></h3>
				<p>
				...
				<h2><b>3. Weitergabe von Daten</b></h2>
				<p>
				...
				<ul class="list-disc pl-[1rem]">
					...
					<li>
						...
						S. 1 lit. c DSGVO eine gesetzliche Verpflichtung besteht,
						sowie
					</li>
					<li>
						dies gesetzlich zulässig und nach Art. 6 Abs. 1 S. 1 lit.
						b DSGVO für die Abwicklung von Vertragsverhältnissen mit
				...
				<p>
					...
					notwendige, sogenannte Session-Cookies ein, die nur für die
					aktuelle Browsersitzung bestehen bleiben. Hierbei handelt es
					sich um kleine Dateien, die Ihr Browser automatisch erstellt
					und die auf Ihrem Endgerät (Laptop, Tablet, Smartphone o.ä.)
					gespeichert werden, wenn Sie unsere Internetseiten besuchen.
					Generell richten Cookies auf Ihrem Endgerät keinen Schaden
					an, enthalten keine Viren, Trojaner oder sonstige
					Schadsoftware. Beim Verlassen unserer Website werden diese
					Session-Cookies automatisch wieder gelöscht.
				</p>
				<p>
					Der Einsatz von Cookies dient einerseits dazu, die Nutzung
					unseres Angebots für Sie angenehmer zu gestalten bzw. die
				...
				<p>
					...
					führen, dass Sie nicht alle Funktionen unserer Website
					nutzen können.
				</p>

				<h2><b>5. YouTube</b></h2>
				<p>
					Wir setzen auf unseren Internetseiten Videos des
					Videoportals „YouTube“ des Unternehmens Google Ireland
					Limited, Gordon House, Barrow Street, Dublin 4, Irland (Im
					Folgenden: „Google“) ein. Die Implementierung erfolgt
					aufgrund von Art. 6 Abs. 1 S. 1 lit. f DSGVO, wobei unser
					Interesse in der reibungslosen Integration der Videos und
					der damit ansprechenden Gestaltung unserer Webseite liegt.
				</p>
				<p>
					Hierbei nutzen wir die von Google zur Verfügung gestellte
					Option des erweiterten Datenschutzmodus.
				</p>
				<p>
					Wenn Sie eine Seite aufrufen, die über ein eingebettetes
					Video verfügt, wird eine Verbindung zu den Google-Servern
					hergestellt und dabei der Inhalt durch Mitteilung an Ihren
					Browser auf der Internetseite dargestellt.
				</p>
				<p>
					Laut den Angaben von Google werden im erweiterten
					Datenschutzmodus nur dann Ihre Daten – insbesondere welche
					unserer Internetseiten Sie besucht haben sowie
					gerätespezifische Informationen inklusive der IP-Adresse –
					an den YouTube-Server in den USA übermittelt, wenn Sie das
					Video anschauen. Durch den Klick auf das Video willigen Sie
					in diese Übermittlung ein.
				</p>
				<p>
				...
				<p>
					Teilweise werden Informationen an die Muttergesellschaft
					Google Inc. mit Sitz in den USA, an andere
					Google-Unternehmen und an externe Partner von Google
					übermittelt, die sich jeweils außerhalb der Europäischen
					Union befinden können. Google verwendet dafür von der
					Europäischen Kommission genehmigte Standardvertragsklauseln
					und verlässt sich auf die von der Europäischen Kommission
					erlassenen Angemessenheitsbeschlüsse bezüglich bestimmter
					Länder.
				</p>
				<p>
					Weitere Informationen zum Datenschutz im Zusammenhang mit
					YouTube finden Sie in den Datenschutzbestimmungen von
					Google.
				</p>

				<h2><b>6. Betroffenenrechte</b></h2>
				...
				<p>
					...
					oder sich der Widerspruch gegen Direktwerbung richtet. Im
					letzteren Fall haben Sie ein generelles Widerspruchsrecht,
					das ohne Angabe einer besonderen Situation von uns umgesetzt
					wird. Möchten Sie von Ihrem Widerrufs- oder
				...
				<h2>
					<b
						>9. Aktualität und Änderung dieser Datenschutzerklärung</b
					>
				</h2>
				<p>
					...
					unter https://miteinander-fuer-afrika.de/datenschutz.html
