	...
	<div class="min-h-[100vh] grid place-items-center">
		<article
			...
			<form
				...
				<h1 class="text-big text-orange font-bold">
					Newsletter bestellen
				</h1>
				<p>
					Um aktuelle Informationen (Jahresbrief, zu Aktionen,
					Veranstaltungen und Neuigkeiten auf der Homepage) erhalten
					zu können, haben Sie die Möglichkeit, unseren Newsletter zu
					abonnieren.
				</p>
				<div>
					<label
				...
				<div class="form-control">
					<label
						...
						<span class="label-text text-sm"
							>Ich bin damit einverstanden, dass mich der Betreiber
							und Herausgeber über ausgewählte Themen informieren
							darf. Meine Daten werden ausschließlich zu diesem Zweck
