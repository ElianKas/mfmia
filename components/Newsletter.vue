...
<template>
	<aside
		...
		<form
			...
			<h2 class="text-big text-orange font-bold">Newsletter bestellen</h2>
			<p>
			...
			<div class="form-control">
				<label class="label cursor-pointer flex items-start gap-[1rem]">
					...
					<span class="label-text text-sm"
						...
						Insbesondere erfolgt keine Weitergabe an unberechtigte Dritte. Mir ist bekannt, dass ich
						meine Einwilligung jederzeit mit Wirkung für die Zukunft widerrufen kann. Es gilt die
						<NuxtLink
							to="/datenschutz"
							class="text-orange"
